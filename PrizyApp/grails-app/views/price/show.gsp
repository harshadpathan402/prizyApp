	...
	<body>
		...
		<div id="show-price" class="content scaffold-show" role="main">
			...
			<ol class="property-list price">
				...
				<g:if test="${priceInstance?.note}">
				<li class="fieldcontain">
					<span id="note-label" class="property-label"><g:message code="price.note.label" default="Note" /></span>
					
						<span class="property-value" aria-labelledby="note-label"><g:fieldValue bean="${priceInstance}" field="note"/></span>
