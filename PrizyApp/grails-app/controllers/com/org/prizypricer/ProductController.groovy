...
class ProductController {
    ...
    def save(Product productInstance) {
        ...
        request.withFormat {
            form multipartForm {
                ...
                redirect productInstance: productInstance
            }
	...
	def idealPrice(){//for calculating ideal price
		println "params :: " +params
		def productInstance = Product.get(params.id)
		println "productInstance :::::::  " + productInstance
			render(template: 'ideal', model: [price:priceService.getIdealPrice(productInstance, params.formula),productInstance:productInstance])
	}
