...
class PriceController {
	...
	def bindPriceObject(Price productPriceInstance, params) {
		bindData(productPriceInstance, params)
		def product  = Product.findByBarcode(params.barcode as String)
		productPriceInstance.product  = product
	}
    ...
    def save(Price priceInstance) {
		...
		bindPriceObject(priceInstance, params)
        ...
        request.withFormat {
            form multipartForm {
                ...
                redirect priceInstance : priceInstance
            }
